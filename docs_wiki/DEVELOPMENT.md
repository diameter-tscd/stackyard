...
This guide covers how to extend and customize stackyrd for your specific needs. Learn to add new services, integrate databases, handle API requests, and deploy your application.

## Adding New Services

Services are the core building blocks of stackyrd applications. Each service encapsulates business logic and exposes API endpoints.
...
stackyrd provides built-in request validation and standardized responses.
...
stackyrd uses an automatic service discovery system that eliminates the need for manual service registration:
...
Now that you understand how to develop with stackyrd, explore:
